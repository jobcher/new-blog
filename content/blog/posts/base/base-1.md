...
|码制|定点整数|定点小数|
|:----|:----|:----|
|原码|{{< katex "-(2^{n-1}-1)~+(2^{n-1}-1)" true />}}|{{< katex "-(1-2^{-(n-1)})~+(1-2^{-(n-1)})" true />}}|
|反码|{{< katex "-(2^{n-1}-1)~+(2^{n-1}-1)" true />}}|{{< katex "-(1-2^{-(n-1)})~+(1-2^{-(n-1)})" true />}}|
|补码|{{< katex "-2^{n-1}~+(2^{n-1}-1)" true />}}|{{< katex "-1~+(1-2^{-(n-1)})" true />}}|
|移码|{{< katex "-2^{n-1}~+(2^{n-1}-1)" true />}}|{{< katex "-1~+(1-2^{-(n-1)})" true />}}|
### 校验码
